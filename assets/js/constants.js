export const DEFAULT_FORM_CLASSES={
	...
	formHide:'blankout',
	formFrame:'square',
	inputRowContainer:'input-row-container',
...
export const DIRECTION_UP='ASC';
export const DIRECTION_DOWN='DESC';

export const COUNTRIES_ID='country_id';
export const COUNTRIES_NAME='country_name';
export const COUNTRIES_CODE2='code_2';
export const COUNTRIES_CODE3='code_3';
...
export const POSTAGE_DESCRIPTION='description';